...
apt-get update
apt-get -y install wget git-core build-essential libssl-dev libffi-dev python-dev python3-pip python3-numpy python3-scipy

# install all Python3 libraries
printf "${BLUE}Installing python3 libraries and packages...${NC}\n"
pip3 install jupyter pandas keras PyMySQL requests tensorflow==1.5.0 geopandas==0.2.1 uwsgi flask scikit-learn pillow h5py seaborn
